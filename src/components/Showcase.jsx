                    ...
                    <div className="wrapper">
                        <div className="lg:max-w-md">
                            ...
                            <div className="space-y-5 mt-7 pe-10">
                                ...
                                <p>
                                    the thinnest and lightest MacBook Pros ever. With up to 12 CPU cores
                                    and up to 19 GPU cores, M4 delivers incredible performance and
                                    efficiency, so you can work, play, and create like never before.
                                </p>
                                <p>
                                    Experience blazing-fast speeds, stunning graphics, and all-day battery
                                    life in a sleek and portable design. The future of MacBook Pro is here,
                                    and it's powered by M4.
                                </p>
